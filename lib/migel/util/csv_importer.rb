  ...
  module Util
    class CsvImporter
      ...
      def report(lang = "de")
        ...
        if @migel_codes_without_products and @migel_codes_without_products.size > 0
      ...
      def delete_all_inactive_bauerfeind_products
        ...
        Migel::Model::Migelid.all.each do |migel_id|
          ...
          migel_id.products.find_all { |x| x&.companyname&.de && /bauerfeind/i.match(x.companyname.de.force_encoding("UTF-8")) }.each do |product|
          ...
          migel_id.products.delete_if { |x| x&.companyname&.de && /bauerfeind/i.match(x.companyname.de.force_encoding("UTF-8")) }
